...
const AlgorithmBookClub = () => <div>
    ...
    <p>We also often discussed the paradigms that particular algorithms often belong to, and many contributors including myself provided functional examples of algorithms traditionally presented as imperative, and the trade-offs incurred by using a higher-level paradigm.</p>
